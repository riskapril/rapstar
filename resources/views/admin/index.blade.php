  ...
  <body>
        ...
        <div class="">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
              <a class="dropdown-item fa fa-user" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Logout') }}</a><form id="logout-form" action="{{ route('logout') }}" method="POST" style= "display:none;">
			   @csrf
				</form>
